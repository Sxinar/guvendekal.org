...
description: "İçerik Kuralları hakkında detaylı bilgi"
---
...
> Sayfa ve menüleri eklemek ve düzeltmeyi öğrenmek için [**buraya**](/guides/ekleme/) bakabilirisiniz.
...
- İçeriğin yapısı estetik, kullanıcıya hitap edecek şekilde olmalıdır.
 ...
 - **Kalın yazı**, _eğik yazı_ gibi biçimler, tablolar, notlar ve alıntı kullanılmalıdır. [**Biçimlendirme**](/guides/bicimlendirme/) sayfasına bakabilirsiniz.
