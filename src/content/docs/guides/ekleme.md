---
title: "Ekleme Yap"
description: "Ekleme Yap hakkında detaylı bilgi"
---
...
İçerikleri yazarken uymanız gereken kurallara [**İçerik Kuralları**](/guides/icerik-kurallari/) sayfasından erişebilirsiniz.
...
Görseller `guvendekal.org/images/` klasörüne yüklenir. Bu klasöre eklediğiniz `guvendekal.png` adlı görseli bir yazıya eklemek için `![Resim Açıklaması](/images/guvendekal.png)` kodunu kullanabilirsiniz.
