...
description: "Dosya Dönüştürme hakkında detaylı bilgi"
---
...
|----------|:-----------:|:-----------:|:-----------:|:--------------------:|:----------------:|
| <span style="display: inline-block; vertical-align: middle;"><img src="/images/fileconverter-icon.png" alt="fileconverter" style="width: 30px; height: 30px;" /> </span> <span style="display: inline-block; vertical-align: middle;"> File Converter </span> | <span style="color: green;">✓</span> | AGPL-3.0 | Yerel | <i class="fa-solid fa-image"></i> <i class="fa-solid fa-music"></i> <i class="fa-solid fa-file"></i> <i class="fa-solid fa-video"></i>  | <i class="fa-brands fa-windows"></i> |
| <span style="display: inline-block; vertical-align: middle;"><img src="/images/handbrake-icon.png" alt="handbrake" style="width: 30px; height: 30px;" /> </span> <span style="display: inline-block; vertical-align: middle;"> HandBrake </span> | <span style="color: green;">✓</span> | GPL-2.0 | Yerel | <i class="fa-solid fa-video"></i> | <i class="fa-brands fa-windows"></i> <i class="fa-brands fa-apple"></i> <i class="fa-brands fa-linux"></i> |
| <span style="display: inline-block; vertical-align: middle;"><img src="/images/vert-icon.jpg" alt="vert" style="width: 30px; height: 30px; border-radius: 10px;" /> </span> <span style="display: inline-block; vertical-align: middle;"> VERT.sh </span> | <span style="color: green;">✓</span> | AGPL-3.0 | Bulut | <i class="fa-solid fa-image"></i> <i class="fa-solid fa-music"></i> <i class="fa-solid fa-file"></i> <i class="fa-solid fa-video"></i> | <i class="fa-solid fa-globe">  |

### <span style="display: inline-block; vertical-align: middle;"><img src="/images/fileconverter-icon.png" alt="fileconverter" style="width: 50px; height: 50px;" /> </span> <span style="display: inline-block; vertical-align: middle;"> File Converter
...
### <span style="display: inline-block; vertical-align: middle;"><img src="/images/handbrake-icon.png" alt="handbrake" style="width: 50px; height: 50px;" /> </span> <span style="display: inline-block; vertical-align: middle;"> HandBrake
...
### <span style="display: inline-block; vertical-align: middle;"><img src="/images/vert-icon.jpg" alt="vert" style="width: 50px; height: 50px; border-radius: 10px;" /> </span> <span style="display: inline-block; vertical-align: middle;"> VERT.sh

[**VERT**](https://vert.sh/), video dışındaki tüm dosyaları doğrudan cihazınızda dönüştürür; dosyalar sunucuya gönderilmez ve üçüncü kişiler tarafından görülmez. Video dönüştürmeleri ise yüksek performanslı Vert sunucularında yapılır; videolar indirme sonrası veya en geç 1 saat içinde otomatik olarak silinir ve izniniz olmadan saklanmaz. Vert, dosya veya boyut sınırı olmadan 250’den fazla formatı destekler, kişisel veri toplamaz, çerez veya izleyici kullanmaz ve gizliliği ön planda tutar.

- [Açık kaynak depo](https://github.com/VERT-sh/VERT)
- [Gizlilik politikası](https://vert.sh/privacy/)
